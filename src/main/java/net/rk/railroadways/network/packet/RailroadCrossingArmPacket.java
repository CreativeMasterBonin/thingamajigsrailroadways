...
public class RailroadCrossingArmPacket{
    ...
    public static RailroadCrossingArmPacket get(){return INSTANCE;}

    public void handle(final RailroadCrossingArmPayload payload, final IPayloadContext context){
        ...
        if(rcbe == null){
            Logger.getAnonymousLogger().warning("Railroad Crossing BE at: " + payload.bp() + " is null! This is not normal!");
            return;
        }
